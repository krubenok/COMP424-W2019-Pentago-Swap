...
public class StudentPlayer extends PentagoPlayer {
    ...
    public Move chooseMove(PentagoBoardState boardState) {
        ...
        // strategies... 
        PentagoMove myMove = boardState.getAllLegalMoves().get(0);
        ...
        if (boardState.getTurnNumber() < 2 && boardState.getTurnPlayer() == 0) {
            ...
            myMove = AlphaBeta.alphabeta(MyTools.getDepth(boardState), boardState.getTurnPlayer(), boardState, Integer.MIN_VALUE, Integer.MAX_VALUE).getValue();
        }
        return myMove;
    }
} 